      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <div className="rounded-xl shadow-2xl p-8 space-y-8" style={{ backgroundColor: 'var(--card-background)', border: '1px solid var(--color-border)' }}>
            <div>
              <h2 className="mt-6 text-center text-3xl font-bold tracking-tight" style={{ color: 'var(--color-text)' }}>Create your account</h2>
              <p className="mt-2 text-center text-sm" style={{ color: 'var(--color-subtle-text)' }}>
                Or
                <Link className="font-medium hover:text-[var(--color-primary-hover)] ml-1 transition-colors duration-200" style={{ color: 'var(--color-primary)' }} to="/login"> sign in to your existing account </Link>
              </p>
            </div>
